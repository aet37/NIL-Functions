function [freq, adfreq, n, ts, fn, ad] = plx_ad1(filename, ch)
...
% OUTPUT:
%   freq - sampling rate for event & unit: 40kHz
%   adfreq - sampling rate for continuous signals: 1kHz
