...
%    PlotCSD(csd,<options>)
%
%    csd            current source density (see <a href="matlab:help CSD">CSD</a>; [t(:) CSD(:)])
...
for i = 1:2:length(varargin),
    if ~ischar(varargin{i}),
        error(['Parameter ' num2str(i+2) ' is not a property (type ''help <a href="matlab:help PlotCSD">PlotCSD</a>'' for details).']);
    end
