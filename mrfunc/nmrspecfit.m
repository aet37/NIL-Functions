function e=nmrspecfit(x,t,R2,phi,nsplits,splitfreq,z,type,base,freq)
% Usage ... e=nmrspecfit(x,t,R2,phi,nsplits,splitfreq,z,type,base,freq)
%
...
if nargin<10, freq=0; end;
if nargin<9, base=zeros(size(t)); end;
