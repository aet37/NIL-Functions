function [f]=OIS_corr2c(data,reference,t_flag)
% Usage ... f=OIS_corr2c(data,reference,t_flag)
%
% vectorized version (pixels,time)
...
sumnx=0; 
sumny=0; 
sumnxy=zeros(size(data,1),size(reference,2));
sumnx2=0; 
sumny2=0;
