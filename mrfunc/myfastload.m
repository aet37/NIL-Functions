function [val,count]=myfastload(filename,isize,ibytesize,locations,byteoffset)
% Usage ... [val,count]=myfastload(filename,isize,ibytesize,locations,byteoffset)
% Usage ... [val,count]=myfastload(filename,range,slice,locs,'DMOD')
% Use this format for regular image formats
% For DMOD format substitute isize with range of images
% for timecourse extraction and ibytesize with the slice
% of interest.
