function f=dm_std(dmfile,slc,volrange)
% Usage ... f=dm_std(dmfile,slice,volrange)
%
% Calculates the standard deviation of the set of
...
imsum=(1/dminfo(8))*imsum;
imstd=0;
for m=1:dminfo(8),
  imstd=imstd+((getdmodim(dmfid,m,1)-imsum)).^2;
end;

f=((1/dminfo(8))*imstd).^(0.5);
