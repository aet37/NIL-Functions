function f=loadtc(seqfile,filelength,isize,pixlist)
% Usage ... f=loadtc(seqfile,filelength,isize,pixlist)
...
for m=1:noimages,
  ...
  if rp==1,
    tc(m)=tmpim(pixlist(1),pixlist(2));
  else,
    for o=1:rp, tc(o,m)=tmpim(pixlist(o,1),pixlist(o,2)); end;
  end;
end;
