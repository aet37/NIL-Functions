function quickmap_scr(fname,neig,ntrials,trialdur,stimdur,offset,desiredres,baseims,actims,dipdur,panelims)
% Usage ... quickmap_scr(fname,neig,ntrials,trialdur,stimdur,offset,desiredres,baseims,actims,dipdur,panelims)
...
averageLSI(fname,fps,ntrials,offset,trialdur,desiredres,0,1,neig)

panels=showOISaverage(fname,baseims,2,1,panelims);
