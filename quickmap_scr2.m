function quickmap_scr2(fname,fps,ntrials,trialdur,stimdur,offset,desiredres,baseims,actims,dipdur,panelims)
...
averageOIS2(fname,fps,ntrials,offset,trialdur,desiredres,0,1)
