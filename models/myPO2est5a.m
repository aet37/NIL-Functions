...
for mm=2:length(t),
  ...
  if (RK_flag),
    ...
    Cata=Ca*(1+ca_amp*(Fin(mm-1)/F0-1));
    Catb=Ca*(1+ca_amp*(mean(Fin(mm-1:mm))/F0-1));
    Catc=Ca*(1+ca_amp*(Fin(mm)/F0-1));
