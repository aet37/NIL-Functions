function [Q1a,UU,u1,t]=complG3f(x,tparms,xparms,parms2fit,data,tdata)
% Usage ... complG3f(x,tparms,xparms,parmstofit,data,tdata)
%
% tparms = [dt tfin]
% xparms = [Q0 V0 tau_a tau_a0 tau_a1 t0 w amp N tau_lpf tau_nref kb mttv tau_v E0 B0 TE]
%
...
u1type=[15 xparms(9) xparms(10) xparms(11)];
u2type=[15 xparms(9) xparms(10) xparms(11)];

u1=mytrapezoid3(t,ust,udur,uramp,u1type);
u2=mytrapezoid3(t,ust,udur,uramp,u2type);
...
if (nargin>=5),
  ...
  if (BOLDtype==2),
    ...
    err=[err2(1,:)/max(datai(1,:)-1) err2(2,:)/max(datai(2,:)-1)];
