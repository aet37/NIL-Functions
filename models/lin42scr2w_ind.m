...
for mm=1:size(normo_hyper,2),
  avgE4i=interp1(tt4,normo_hyper(:,mm),t);
  avgE4bi=interp1(tt4,hyper(:,mm),t);

  xx1e=lsqnonlin(@lin42,xg(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,xg,parms2fit,[avgE4i],[W4]);
  xg1e=xg; xg1e(parms2fit)=xx1e;
  xx2e=lsqnonlin(@lin42,xg(parms2fit2),xl(parms2fit2),xu(parms2fit2),opt2,t,xg,parms2fit2,[avgE4bi],[W4b]);
  xg2e=xg1e; xg2e(parms2fit2)=xx2e;
  xx2e2=lsqnonlin(@lin42,xg2e(parms2fit3),xl(parms2fit3),xu(parms2fit3),opt2,t,xg2e,parms2fit3,[avgE4bi],[W4b]);
  xg2e2=xg2e; xg2e2(parms2fit3)=xx2e2;

end;

for mm=1:size(normo_hypo,2),
  avgE4i=interp1(tt4,normo_hypo(:,mm),t);
  avgE4ci=interp1(tt4,hypo(:,mm),t);
