...
vcAmp=0.4;		% 0.0, 0.4, 1.0
ps1Amp=-0.90;
vc1Amp=0.0;

sparms=[ F0  V0 Vk1 dCMRO2 P50 cHb Vc Vct  PS  Pa  Pt  beta fp2cmro2 PS1 Vc1 caAmp vcAmp ps1Amp vc1Amp];
slb=[30  1  1/60  -0.5 20 1.0 0.01 97.9  2000 80   0 0.00000 0.001 2000 0 0 0 0 0 -1 0];
sub=[120 10 40/60 +2.0 31 3.0 5.00 98.1  30000 300 70 10.00001 70   20e3 1e6 30000 5 1 4 4 4];
