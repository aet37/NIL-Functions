...
Paend3=40;	ra3=40e-6*1e+3;	la3=1.0e-3*1e+3;
Pendcap=20;	rcap=5e-6*1e+3;	lcap=400e-6*1e+3;
Pvend3=6;	rv3=80e-6*1e+3;	lv3=5.0e-3*1e+3;
...
if (verbose_flag),
  ...
  disp(sprintf('Rart= %1.2e  Lart= %1.2e',ra3,la3));
  disp(sprintf('Rcap= %1.2e  Lcap= %1.2e',rcap,lcap));
  disp(sprintf('Rven= %1.2e  Lven= %1.2e',rv3,lv3));
  disp(sprintf('Pentry0= %1.2e  dPs=[%2.1f %2.1f %2.1f]',Pentry0,Pda3,Pdcap,Pdv3));
  disp(sprintf('  (%2.1f,%2.1f,%2.1f,%2.1f)',Paend2,Paend3,Pendcap,Pvend3));
  disp(sprintf('VcapVart= %1.2e  VvenVcap= %1.2e',VcapVart,VvenVcap));
end;
