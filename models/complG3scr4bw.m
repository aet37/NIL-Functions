...
%xg=[ 1    1    3   2.0    0    1    12   0.636  0.00  1.5/60 0.0347 2.0601/60 11.5 0.6807 3.0  28e-3];  % same as bold/fair
%xg=[ 1    1    3   2.0    0    1    12   0.636  0.00  1.5/60 0.0339 1.3620/60 11.5 0.6995 3.0  28e-3];
xg=[ 1    1    3   2.0    0    1    12   0.636  0.00  1.5/60 0.0334 1.2929/60 11.5 0.7100 3.0  28e-3];  % bold only
...
% weight originally 14 after stimulation off-set
W1i=mytrapezoid3(t1,2*(t1(2)-t1(1)),(60+14)/60,2*(t1(2)-t1(1)));
W2i=mytrapezoid3(t2,2*(t2(2)-t2(1)),(12+12)/60,2*(t2(2)-t2(1)));
W3i=mytrapezoid3(t3,2*(t3(2)-t3(1)),(06+12)/60,2*(t3(2)-t3(1)));


xg1(7)=60; xl1(7)=58; xu1(7)=64;
xx1=lsqnonlin(@complG3fw,xg1(parms2fit),xl1(parms2fit),xu1(parms2fit),opt2,tparms1,xg1,parms2fit,[avgE1i],t1,[W1i]);
...
xx2=lsqnonlin(@complG3fw,xg2(parms2fit),xl2(parms2fit),xu2(parms2fit),opt2,tparms2,xg2,parms2fit,[avgE2i],t2,[W2i]);
...
xx2b=lsqnonlin(@complG3fw,xg2b(parms2fit2),xl2(parms2fit2),xu2(parms2fit2),opt2,tparms2,xg2b,parms2fit2,[avgE2bi],t2,[W2i]);
...
xx3=lsqnonlin(@complG3fw,xg3(parms2fit),xl3(parms2fit),xu3(parms2fit),opt2,tparms3,xg3,parms2fit,[avgE3i],t3,[W3i]);
...
xx3b=lsqnonlin(@complG3fw,xg3b(parms2fit2),xl3(parms2fit2),xu3(parms2fit2),opt2,tparms3,xg3b,parms2fit2,[avgE3bi],t3,[W3i]);
