...
%load co2_4vals tt3 avgE2 avgE2b avgC2 avgC2b tt3
co2scr6,
%avgV3=avgV3-avgV3(1)+1;
%avgV3b=avgV3b-(avgV3b(1)-1)/2;
...
xg=[ 1    1    3   2.5   0     1    6   0.65   0   1.5/60 0.022 1.1/60 13.9 0.35];
xl=[0.1  0.1  0.5  0.1     0    0.0  4.0  0.1   0  0.1/60 1e-5 0.1/60 0 0.2];
xu=[100  100  100  100    100    5   9.0  7.0   2    5/60 2  10/60 200 0.7];
...
avgV3i=interp1(tt3,avgV3,t);
avgV3bi=interp1(tt3,avgV3b,t);

xx=lsqnonlin(@complG3f,xg(parms2fit),xl(parms2fit),xu(parms2fit),opt2,tparms,xg,parms2fit,[avgV3],tt3);
[yy,uu,u1,t]=complG3f(xx,tparms,xg,parms2fit);
ee=sum(sum(([avgV3i]-yy).^2))/(2*length(t));

xx2=lsqnonlin(@complG3f,xg(parms2fit),xl(parms2fit),xu(parms2fit),opt2,tparms,xg,parms2fit,[avgV3b],tt3);
[yy2,uu2,u2,t]=complG3f(xx2,tparms,xg,parms2fit);
ee2=sum(sum(([avgV3bi]-yy2).^2))/(2*length(t));
...
subplot(211)
plot(tt3,avgV3,'b--',tt3,avgV3b,'r--',t,yy(1,:),'b-',t,yy2(1,:),'r-')
ylabel('AVIS Signal'),
