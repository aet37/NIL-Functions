...
elseif (fittype==7),
  ...
  [x7,resn7,res7,ex7,out7,lam7,jac7]=lsqnonlin(@myBOLD4,sparms7(parms2fit7),slb7(parms2fit7),sub7(parms2fit7),opt4,tparms,sparms7,parms2fit7,iunfix,[ifix;xfix(ifix)]',tt2i,[avgE2i;avgC2i]');
  %[St,Fin,Fout,VV,CMRO2t,EEt,q,t]=myBOLD4(sparms7(parms2fit7),tparms,sparms7,parms2fit7,iunfix,[ifix;xfix(ifix)]',tt2i,[avgE2i;avgC2i]');
  [Er,St,Fin,Fout,VV,CMRO2t,EEt,q,t,CCt,CCc]=myBOLD4(x7,tparms,sparms7,parms2fit7,iunfix,[ifix;xfix(ifix)]',tt2i,[avgE2i;avgC2i]');
...
elseif (fittype==8),
  ...
  %x8=sparms(parms2fit);
  [x8,resn8,res8,ex8,out8,lam8,jac8]=lsqnonlin(@myBOLDnc2,sparms(parms2fit),slb(parms2fit),sub(parms2fit),opt4,tparms,sparms,parms2fit,[avgE2;avgC2]',tt2);
  %[St,Fin,Fout,VV,CMRO2t,EEt,q,Ut,t]=myBOLDnc2(x8,tparms,sparms,parms2fit,[avgE2;avgC2;(~tss)+1]',tt2);
  %[St,Fin,Fout,VV,CMRO2t,EEt,q,Ut,t]=myBOLDnc2(x8,tparms,sparms,parms2fit,[avgE2;avgC2]',tt2);
