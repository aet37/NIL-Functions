...
%parms2fit2=[3 6 13];		% originial NIMG submission
parms2fit2=[3 13];		% removed t0
doadjust=1;
...
xx1=lsqnonlin(@complG3f,xg1(parms2fit),xl(parms2fit),xu(parms2fit),opt2,tparms,xg1,parms2fit,avgE4,tt4);
%xx1new=xx1; load complG3s3fix xx1
[yy,uu,u1,t]=complG3f(xx1,tparms,xg1,parms2fit);
...
xx2=lsqnonlin(@complG3f,xg2(parms2fit2),xl(parms2fit2),xu(parms2fit2),opt2,tparms,xg2,parms2fit2,avgE4b,tt4);
[yy2,uu2,u2,t]=complG3f(xx2,tparms,xg2,parms2fit2);
...
xx3=lsqnonlin(@complG3f,xg3(parms2fit2),xl(parms2fit2),xu(parms2fit2),opt2,tparms,xg3,parms2fit2,avgE4c,tt4);
[yy3,uu3,u3,t]=complG3f(xx3,tparms,xg3,parms2fit2);
