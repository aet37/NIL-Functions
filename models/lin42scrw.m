...
xx1=lsqnonlin(@lin42,xg1(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,xg1,parms2fit,[avgE1i],[W1]);
xx1new=xx1; load /Users/towi/Documents/Publications/VascularDynamics-Figures/lin42resW2b xx1

xg2=xg; xg2(9)=12.0; xl(9)=10.0; xu(9)=16.0;
xx2=lsqnonlin(@lin42,xg2(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,xg2,parms2fit,[avgE2i],[W2]);
xx2new=xx2; load /Users/towi/Documents/Publications/VascularDynamics-Figures/lin42resW2b xx2
xg2(parms2fit)=xx2;
xx2b=lsqnonlin(@lin42,xg2(parms2fit2),xl(parms2fit2),xu(parms2fit2),opt2,t,xg2,parms2fit2,[avgE2bi],[W2]);
xg2b=xg2; xg2b(parms2fit2)=xx2b;
xg2c=xg2; 
xx2c=lsqnonlin(@lin42,xg2(parms2fit3),xl(parms2fit3),xu(parms2fit3),opt2,t,xg2,parms2fit3,[avgE2bi],[W2]);

xg3=xg; xg3(9)=6.0; xl(9)=4.0; xu(9)=10.0;
xx3=lsqnonlin(@lin42,xg3(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,xg3,parms2fit,[avgE3i],[W3]);
xx3new=xx3; load /Users/towi/Documents/Publications/VascularDynamics-Figures/lin42resW2b xx3
xg3(parms2fit)=xx3;
xx3b=lsqnonlin(@lin42,xg3(parms2fit2),xl(parms2fit2),xu(parms2fit2),opt2,t,xg3,parms2fit2,[avgE3bi],[W3]);
xg3b=xg3; xg3b(parms2fit2)=xx3b;
xg3c=xg3; 
xx3c=lsqnonlin(@lin42,xg3(parms2fit3),xl(parms2fit3),xu(parms2fit3),opt2,t,xg3,parms2fit3,[avgE3bi],[W3]);
...
[yy2c]=lin42(xx2c,t,xg2,parms2fit3);
[yy3,ww3,vv3]=lin42(xx3,t,xg3,parms2fit);
[yy3b,ww3b,vv3b]=lin42(xx3b,t,xg3,parms2fit2);
[yy3c]=lin42(xx3c,t,xg3,parms2fit3);

err1=sum((avgE1i'-yy1).^2)/sum(W1>0);
err2=sum((avgE2i'-yy2).^2)/sum(W2>0);
err3=sum((avgE3i'-yy3).^2)/sum(W3>0);
err2b=sum((avgE2bi'-yy2b).^2)/sum(W2>0);
err3b=sum((avgE3bi'-yy3b).^2)/sum(W3>0);
err2c=sum((avgE2bi'-yy2c).^2)/sum(W2>0);
err3c=sum((avgE3bi'-yy3c).^2)/sum(W3>0);
format short e
