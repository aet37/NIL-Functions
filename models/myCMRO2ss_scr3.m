...
elseif (fittype==7),
  ...
  %xfix=mytrapezoid(tt1i,7.0/60,57/60,4/60);
  %xfix=mytrapezoid(tt1i,6.0/60,55.5/60,5/60);
  xfix=mytrapezoid(tt1i,4.0/60,57.5/60,3/60);
  ifix=find(tssi);
  iunfix=find(~tssi);

  %[tau_a tau_v Vt kb]
  sparms7=[sparms(7:end) 0.005 xfix(iunfix)];
  parms2fit7=[4 11 length(sparms(7:end))+[1:length(iunfix)]+1 ];
  slb7=[slb(7:end) 0.0 xfix(iunfix)-0.7];
  sub7=[sub(7:end) 10.0 xfix(iunfix)+0.7];
  [x7,resn7,res7,ex7,out7,lam7,jac7]=lsqnonlin(@myBOLD4,sparms7(parms2fit7),slb7(parms2fit7),sub7(parms2fit7),opt4,tparms,sparms7,parms2fit7,iunfix,[ifix;xfix(ifix)]',tt1i,[avgE1i;avgC1i]');
  %[St,Fin,Fout,VV,CMRO2t,EEt,q,t]=myBOLD4(sparms3(parms2fit3),tparms,sparms3,parms2fit3,iunfix,[ifix;xfix(ifix)]',tt1i,[avgE1i;avgC1i]');
  [Er,St,Fin,Fout,VV,CMRO2t,EEt,q,t]=myBOLD4(x7,tparms,sparms7,parms2fit7,iunfix,[ifix;xfix(ifix)]',tt1i,[avgE1i;avgC1i]');
...
elseif (fittype==8),
  ...
  %x8=sparms(parms2fit);
  [x8,resn8,res8,ex8,out8,lam8,jac8]=lsqnonlin(@myBOLDnc2,sparms(parms2fit),slb(parms2fit),sub(parms2fit),opt4,tparms,sparms,parms2fit,[avgE1;avgC1]',tt1);
  %[St,Fin,Fout,VV,CMRO2t,EEt,q,Ut,t]=myBOLDnc2(x8,tparms,sparms,parms2fit,[avgE1;avgC1;(~tss)+1]',tt1);
  %[St,Fin,Fout,VV,CMRO2t,EEt,q,Ut,t]=myBOLDnc2(x8,tparms,sparms,parms2fit,[avgE1;avgC1]',tt1);
  %myBOLDnc2(x8,tparms,sparms,parms2fit,[avgE1;avgC1]',tt1);
  [St,Fin,Fout,VV,CMRO2t,EEt,q,Ut,t,UUt,CCt,CCc]=myBOLDnc2(x8,tparms,sparms,parms2fit);
