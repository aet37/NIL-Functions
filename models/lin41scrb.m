...
xg=[0.5   0.1   7.5   0.1099  0.196  0.286  0.003000];
...
opt2.TolPCG=1e-2;
opt2.TolFun=1e-6;
opt2.DiffMinChange=1e-08;

xg1=xg;
xx1=lsqnonlin(@lin41,xg1(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,u1,xg1,parms2fit,[avgC1i],[W1]);
xg2=xg;
xx2=lsqnonlin(@lin41,xg2(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,u2,xg2,parms2fit,[avgC2i],[W2]);
xg2(parms2fit)=xx2;
xx2b=lsqnonlin(@lin41,xg2(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,u2,xg2,parms2fit,[avgC2bi],[W2]);
xg3=xg;
xx3=lsqnonlin(@lin41,xg3(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,u3,xg3,parms2fit,[avgC3i],[W3]);
xg3(parms2fit)=xx3;
xx3b=lsqnonlin(@lin41,xg3(parms2fit),xl(parms2fit),xu(parms2fit),opt2,t,u3,xg3,parms2fit,[avgC3bi],[W3]);
%xx=xg(parms2fit);
