...
[CCt_0,CCc_0,CMRO2t_0,t,CCat_0]=myPO2est5b(sparms(parms2fit),tparms,sparms,parms2fit,iunfix,[ifix;xfix(ifix)']',ttt,(CBFt-CBFt(1))/60,[CBF2i(:) FP2env(:)]);
[xx,xresn,xres,xexflag,xout,xlam,xjac]=lsqnonlin(@myPO2est5b,sparms(parms2fit),slb(parms2fit),sub(parms2fit),xopt,tparms,sparms,parms2fit,iunfix,[ifix;xfix(ifix)']',ttt,(CBFt-CBFt(1))/60,[CBF2i(:) FP2env(:) PO2d2(:)*PO2d2_base]);
[CCt,CCc,CMRO2t,t,CCa]=myPO2est5b(xx,tparms,sparms,parms2fit,iunfix,[ifix;xfix(ifix)']',ttt,(CBFt-CBFt(1))/60,[CBF2i(:) FP2env(:)]);
