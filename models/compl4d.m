...
dpm_dt(1) = (1/c1)*( ((pin-pm(1))/r1) - ((pm(1)-pm(2))/r2) );
dpm_dt(2) = (1/c2)*(1/n2)*( ((pm(1)-pm(2))/r2) - ((pm(2)-pm(3))/r3) );
dpm_dt(3) = (1/c3)*(1/n3)*( ((pm(2)-pm(3))/r3) - ((pm(3)-po)/r4) );

e0=0.4;
deff=((0.5*((pm10-pm20)/r2 + (pm20-pm30)/r3 ))/v02)*log(1/(1-e0));
deff=deff*v2;
e=1-exp(-deff/(0.5*( (pm(1)-pm(2))/r2 + (pm(2)-pm(3))/r3 )));

q=pm(4);
q0=1;
dq_dt = (e/e0)*((pm(2)-pm(3))/r3)/v03 - (q/q0)*((pm(3)-po)/r4)/v3 ;
dpm_dt(4)=dq_dt;
