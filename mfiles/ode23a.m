function [tout, yout] = ode23ap7(ypfun, t0, tfinal, y0, tol, trace, g0, g1)
...
while (t < tfinal) & (t + h > t)
   ...
   % Compute the slopes
   s1 = feval(ypfun, t, y, g0, g1); s1 = s1(:);
   s2 = feval(ypfun, t+h, y+h*s1, g0, g1); s2 = s2(:);
   s3 = feval(ypfun, t+h/2, y+h*(s1+s2)/4, g0, g1); s3 = s3(:);
