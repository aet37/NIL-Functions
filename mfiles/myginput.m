function [out1,out2,out3] = ginput(arg1,pointer_type)
%GINPUT Graphical input from mouse.
%   [X,Y] = GINPUT(N,pointer_type) gets N points from the current axes and returns
...
if ischar(pointer_type),
    if strcmp(pointer_type,'crosshair'),
        pointer_type=[];
    elseif strcmp(pointer_type,'smallcrosshair'),
        pointer_type='crosshair';
    elseif strcmp(pointer_type,'yellow'),
        crosshair_color=[1 1 0];
        pointer_type=[];
    elseif strcmp(pointer_type,'red'),
        crosshair_color=[1 0 0];
        pointer_type=[];
    elseif strcmp(pointer_type,'green'),
        crosshair_color=[0 1 0];
        pointer_type=[];
    elseif strcmp(pointer_type,'blue'),
        crosshair_color=[0 0 0];
        pointer_type=[];
    elseif strcmp(pointer_type,'magenta'),
        crosshair_color=[1 0 1];
        pointer_type=[];
    end
end
