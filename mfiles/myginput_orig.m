function [out1,out2,out3] = ginput(arg1, gopt)
...
do_pointer=0; 
do_xhaircolor=0;
if ~exist('gopt'), gopt=[]; end;
if ~isempty(gopt), if ischar(gopt), do_pointer=1; else, do_xhaircolor=1; xhaircolor=gopt; end; end;
