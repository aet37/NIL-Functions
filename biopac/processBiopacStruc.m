function y=processBiopacStruc(x,fs,fco,t0avg,dtt,po2cal,po2tr,refvar)
% Usage ... y=processBiopacStruc(x,fs,fco,t0avg,dtt,po2cal,po2tr,refvar)
%
...
if length(fs)==2, interp_flag=1; else, interp_flag=0; end;
if interp_flag, 
