...
if (nargin==1),
  ...
  for mm=2:nargin,
    ...
    subplot(412)
    eval(sprintf('plot(b%d.tt,b%d.pO2Acalfilt*b%d.pO2Acalfiltbase,''%s'');',mm,mm,mm,colorstr(mm)));
    subplot(413)
    eval(sprintf('plot(b%d.tt,b%d.pO2Bcalfilt*b%d.pO2Bcalfiltbase,''%s'');',mm,mm,mm,colorstr(mm)));
    subplot(414)
    eval(sprintf('plot(b%d.tt,b%d.pO2Ccalfilt*b%d.pO2Ccalfiltbase,''%s'');',mm,mm,mm,colorstr(mm)));
